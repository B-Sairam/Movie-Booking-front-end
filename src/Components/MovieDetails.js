...
const MovieDetails = () => {
 ...
 <div className='main-poster'>
   ...
   <div className='movie-details'>
    <div className='des-title'><b>{data.movieName}</b>&nbsp;&nbsp;&nbsp;{data.type}</div>
    <span className='heart'><i className="fa-solid fa-heart"></i>&nbsp;{data.like}%</span>
     ...
     <div className='duration'>{data.duration}&nbsp;.&nbsp;{data.categori}</div>
     ...
     <div className='d-btn'>
       <a href={data.trailer} target="_blank" rel="noreferrer">
         ...
         ><i className="fa-solid fa-circle-play"></i> &nbsp; Trailer</Button>
       </a>
       <Link to="/booking">
       <Button bg="#ff1414"
         _hover={{
         ...
         ><i className="fa-solid fa-ticket"></i> &nbsp; Booking Tickets</Button>
       </Link>
     </div>
   </div>
   </div>
 ...
 <div className='about-movie'>
       ...
       <div className='cast'>
         ...
         {
           data.cast.map((e,i)=>{
             return <div key={i} className="cast-detail">
